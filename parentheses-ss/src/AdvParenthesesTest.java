...
public class AdvParenthesesTest extends TestCase {
		...
		try {
			javax.swing.SwingUtilities.invokeAndWait(new Runnable() {
				public void run() {
					...
					spreadsheet.setCell(0, 1, "=((A1+A1)*A1+A1)+A1-(A1*A1)+A1");
					...
					assertTrue("failed to evaluate formula",
							Double.valueOf(cellText1) == ((double)((123+123)*123+123)+123-(123*123)+123));
				}
			});
