...
public class AverageAddTest extends TestCase{
	...
	protected SpreadSheet spreadSheetInit() {
        ...
        // test1 summing a row
        spreadsheet.setCell(0, 3, "=AVG(A1:C1)+AVG(A1:C1)-AVG(A1:C1)"); // D1
	...
	public final void test1() {
        runOneTest("failed to evaluate formula =AVG(A1:C1)+AVG(A1:C1)",
                0, 3, null, 3.0); 
    }
}
