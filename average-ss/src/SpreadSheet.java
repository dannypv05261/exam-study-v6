...
public class SpreadSheet extends JFrame {
    ...
    protected String average(String firstTok, String secondTok, int depth) throws NumberFormatException {
    	...
    	return this.divide(result, String.valueOf(columns.size()));
    ...
    public String evaluteWrapper(StringTokenizer tokens, int depth){
        ...
        if("AVG".equals(tok)){
    		...
    		tokens.nextToken();
        	tok = this.average(firstTok, secondTok, depth);
        } else {
