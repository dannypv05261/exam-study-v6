...
public class AverageSameColTest extends TestCase{
	...
	protected SpreadSheet spreadSheetInit() {
        ...
        spreadsheet.setCell(1, 0, "3"); // B1
        spreadsheet.setCell(2, 0, "4"); // C1
        
        // test1 summing a row
        spreadsheet.setCell(0, 3, "=AVG(A1:A3)"); // D1
	...
	public final void test1() {
        runOneTest("failed to evaluate formula =AVG(A1:A3)",
                0, 3, null, 3.0); 
    }
}
